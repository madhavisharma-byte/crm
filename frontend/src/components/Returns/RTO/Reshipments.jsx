...
export default function Reshipments() {
    ...
    return (
        <div className="flex min-h-screen bg-white font-sans antialiased">
            {/* Sidebar - following AwaitingActions.jsx, set correct highlighted major section */}
            ...
            <div className="flex-1 flex flex-col min-w-0">
                ...
                <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100 bg-white">
                    <div className="flex items-center gap-6">
                        <h1 className="text-[16px] font-bold text-[#303e67]">Reshipments</h1>
                        {/* Status Tabs */}
                ...
                {/* Table Area: height/width/padding aligned with AwaitingActions.jsx */}
                <main className="flex-1 p-8 max-w-[1600px]">
                    <div className="overflow-x-auto">
                        <table className="w-full text-left min-w-[1400px]">
                            <thead>
                                <tr className="bg-[#e9f0fe]">
                                    {/* Selection Circle Header - optional, but keeping for parity */}
