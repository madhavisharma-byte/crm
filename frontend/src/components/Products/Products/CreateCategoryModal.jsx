...
const CreateCategoryModal = ({ isOpen, onClose }) => {
    ...
    const InputField = ({ placeholder }) => (
        <input
            ...
            className="w-full px-4 py-2.5 bg-[#f8fafc] border border-gray-200 rounded-lg text-sm outline-none focus:border-[#2b6cee] transition-all placeholder:text-[#94a3b8] text-slate-600 shadow-sm"
        />
    );
    ...
    const SelectField = ({ placeholder }) => (
        <div className="relative group">
            <select className="w-full px-4 py-2.5 bg-[#f8fafc] border border-gray-200 rounded-lg text-sm outline-none appearance-none cursor-pointer text-[#94a3b8] focus:border-[#2b6cee] transition-all shadow-sm">
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/40 backdrop-blur-sm p-4">
            <div className="bg-white w-full max-w-4xl rounded-xl shadow-2xl overflow-hidden animate-in fade-in zoom-in duration-200">
                ...
                <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100">
                    <h2 className="text-xl font-bold text-[#303e67]">Create Category</h2>
                    <button
                        onClick={onClose}
                ...
                {/* Modal Footer */}
                <div className="flex justify-end gap-3 px-8 py-6 mt-8">
                    <button
                        type="button"
